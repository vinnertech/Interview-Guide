...
import { jsCurriculum, getJsLessonByParams, getAllJsLessons } from '../../data/javascript-tutorial';
...
export default function JavaScriptLesson() {
  ...
  const lesson = useMemo(() => {
    return getJsLessonByParams(chapterId, lessonId);
  }, [chapterId, lessonId]);
    ...
    return (
      <div className="container py-5 text-center">
        <div className="card p-5 mx-auto rounded-4 shadow-sm border" style={{ maxWidth: '540px', backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)' }}>
          ...
          <p className="text-muted mb-4">The requested JavaScript tutorial module does not exist or has been moved.</p>
          <Link to="/tutorial/javascript" className="btn btn-warning rounded-pill px-4">
  ...
  return (
    <>
      <Helmet>
        <title>{lesson.title} - JavaScript Learning Guide | VinnerTECH</title>
        <meta name="description" content={lesson.summary || lesson.subtitle || `Learn ${lesson.title} in this practical step-by-step JavaScript guide.`} />
      </Helmet>
      ...
      <LessonLayout 
        ...
        basePath="/tutorial/javascript"
        courseTitle="JavaScript Guide"
        storageKey="vinnertech_js_progress"
        icon="bi-filetype-js"
      >
        {/* 1. Learning Objective */}
        {lesson.goal && (
          <div className="p-4 rounded-3 mb-4 shadow-sm" style={{ backgroundColor: 'var(--bg-color)', borderLeft: '5px solid #f59e0b' }}>
