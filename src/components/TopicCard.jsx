  ...
  return (
    <div className="col-12 col-md-6 col-lg-4 col-xl-3 fade-in-up" style={{ animationDelay: `${delay}s` }}>
      <Link to={to} className="text-decoration-none">
        <div className="topic-card h-100 p-4 rounded shadow-sm d-flex flex-column align-items-start transition" style={{ borderColor: `${color}40`, borderBottomColor: color }}>
          <div 
